(function() {
  ...
  execute = function(options) {
    var beginReadingBody, buf, command, commandArgs, commandName, debug, end, fd, fwriter, hEnd, hStart, highWaterMark_READ, highWaterMark_WRITE, input, n, ok, rOptions, rhwm, start, stop, tmpfile, whwm, worker, writer;
