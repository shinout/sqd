(function() {
  ...
  execute = function(options) {
    var beginReadingBody, buf, command, commandArgs, commandName, debug, end, fd, fwriter, hEnd, hStart, input, n, ok, rOptions, start, tmpfile, worker, writer;
    input = options.input, tmpfile = options.tmpfile, command = options.command, start = options.start, end = options.end, n = options.n, hStart = options.hStart, hEnd = options.hEnd, debug = options.debug;
