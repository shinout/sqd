(function() {
  ...
  main = function(options) {
    var command, count, debug, finishProcesses, input, interval, mem, nProcess, onClose, output, rhwm, run, separationOpearator, separator, separatorAsJS, sepcommand, startTime, stop, tmpfiles, whwm;
